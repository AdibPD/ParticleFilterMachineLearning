...
for i=1:noWeights
    weights(:, i) = mvnrnd(0, 10, dimOfData);
...
diffWeights100 = zeros(noStates, 1);
finalWeightHolder = zeros(dimOfData, noStates);
...
for k=1:noStates
    ...
    finalWeightHolder(:, k) = finalWeight;
...
function displayAccuracy(Xtst, Ytst, finalWeight, trueWeight, N)
    ...
    'Accuracy For 1000 Weights: ' + accuracy;
    'Accuracy For 100 Weights: ' + accuracyTrue;
end